              ...
              flex: 14,
                child:  pw.Column(
                  children: [
                    pw.Row(
                      children: [
                        pw.Text("Agreement for Printers on Hire",style: pw.TextStyle(fontWeight: pw.FontWeight.bold,decoration: pw.TextDecoration.underline,),),
                      ],
                    ),
                    pw.SizedBox(height: 2,),
                    pw.Text("THIS AGREEMENT (the “Agreement”) is made as on between\nM/s UD SERVICES , Herein after referred to as ‘’M/s UD SERVICES” withs its official address at K-201 Rajhans Apple Palanpur Jakatnaka Surat\nAnd\nKASTURBA VAIDYAKIYA RAHAT MANDAL(KASTURBA HOSPITAL)\nLALA LAJPATRAI ROAD, MOTA TAIWAD VALSAD\nGUJARAT-396001",style: pw.TextStyle(fontSize: 12)),
                    ...
                    pw.Row(
                      children: [
                        pw.Text("Section 01- Scope of UD SERVICES",style: pw.TextStyle(fontWeight: pw.FontWeight.bold,decoration: pw.TextDecoration.underline,),),
                      ],
                    ),
                    pw.SizedBox(height: 2,),
                    pw.Text("1.Scope of ’M/s UD SERVICES shall be to supply printer.\n2.Supply of Ink.\n3.Supply of A2 PVC white film,Matt.,Glossy Paper and 260gsm RC paper.\n2. UD SERVICES shall make sure that machines are up & running and will do whatever required for uninterrupted printing.",style: pw.TextStyle(fontSize: 12)),
                    pw.SizedBox(height: 3,),
                    pw.Row(
                      children: [
                        pw.Text("Section 02- Scope of UD Client",style: pw.TextStyle(fontWeight: pw.FontWeight.bold,decoration: pw.TextDecoration.underline,),),
                      ],
                    ),
                    pw.SizedBox(height: 2,),
                    pw.Text("1.Client should provide the proper place with power connection for printer.\n2.Client should have moisture free storage for photo paper\n3.Insurance has to be taken care from customer’s end.",style: pw.TextStyle(fontSize: 12)),
                    pw.SizedBox(height: 3,),
                    pw.Row(
                      children: [
                        pw.Text("Section 03- Commercial Term of Contract",style: pw.TextStyle(fontWeight: pw.FontWeight.bold,decoration: pw.TextDecoration.underline,),),
                      ],
                    ),
                    pw.SizedBox(height: 2,),
                    pw.Text("Contract is from INSTALLATION   for a period of 22 months, on agreed terms and conditions on renewal.\nCommercials: Per print or Print counts.\nRs.16/ Per print FOR A2\nRs.32/ Per print FOR A3\nRS 2200 INSTALLATION CHARGE PER PRINTER\nTaxes , as applicable,extra.",style: pw.TextStyle(fontSize: 12)),
                    pw.SizedBox(height: 3,),
                    pw.Row(
                      children: [
                        pw.Text("Section 02- Standard of performance",style: pw.TextStyle(fontWeight: pw.FontWeight.bold,decoration: pw.TextDecoration.underline,),),
                      ],
                    ),
                    pw.SizedBox(height: 2,),
                    pw.Text(". WO/PO in the name of “UD SERVICES’’\n.Payment to be made in name of “UD SERVICES’’\n.Bills will be raised on monthly basis at the end of the month.\n.Payment within 30 days of bill submission.",style: pw.TextStyle(fontSize: 12)),
                    pw.SizedBox(height: 3,),
                    pw.Row(
                      children: [
                        pw.Text("Section 05- Ownership of Materials",style: pw.TextStyle(fontWeight: pw.FontWeight.bold,decoration: pw.TextDecoration.underline,),),
                      ],
                    ),
                    pw.SizedBox(height: 2,),
                    pw.Text("The printers and Dicom softwares keys  provided, with ownership of M/s UD SERVICES and have reserved the right to use the printers and software’s  at customers site.\nM/S UD Services own the Capex of Printer and Software at Clients Premises.\nHospital should take care of the Assets in their premises installed by M/s UD SERVICES and shall be liable to pay against any loss, damage of any kind to assets, will be billed as per the market price.\nUD SERVICES will be taking care of the all maintenance and consumable for the assest installed by company, hence by providing the hazel free operation.\nFor Assets (PRINTER AND SOFTWARES KEYS)     provide by M/s UD SERVICES , if any loss, damage of any kind to assets, will be billed per the market price.",style: pw.TextStyle(fontSize: 12)),
                    pw.SizedBox(height: 3,),
                    pw.Row(
                      children: [
                        pw.Text("Section 06-Termination",style: pw.TextStyle(fontWeight: pw.FontWeight.bold,decoration: pw.TextDecoration.underline,),),
                      ],
                    ),
                    pw.SizedBox(height: 2,),
                    pw.Text("Both the parties to the contract shall have the right to terminate this Agreement before the Completion Date by giving one month’s prior written notice to the others party for 22 day.",style: pw.TextStyle(fontSize: 12)),
                    pw.SizedBox(height: 3,),
